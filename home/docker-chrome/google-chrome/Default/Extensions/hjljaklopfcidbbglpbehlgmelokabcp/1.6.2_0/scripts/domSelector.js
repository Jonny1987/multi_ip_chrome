/**
 * Modified by Jason O'Neill 2017
...
var DomOutline = function (options) {
    ...
    var pub = {},
        self = {
            opts: {
                ...
                classExclude: options.exclude || null,
            ...
            active: false,
            singleHighlightActive: false,
            singleHighlightLoop: null,
            initialized: false,
            elements: {},
        };
    ...
    function draw(e) {
        if (e.target.className.indexOf(self.opts.namespace) !== -1 || e.target.className.indexOf(self.opts.classExclude) !== -1) {
            return;
        }
    ...
    pub.stop = function () {
    	if (self.singleHighlightLoop != null){
    		clearInterval(self.singleHighlightLoop);
    		self.singleHighlightLoop = null;
    	}
    	self.singleHighlightActive = false;
        self.active = false;
    ...
    pub.highlight = function(element){
    	initStylesheet();
    	pub.stop();
    	self.singleHighlightActive = true;
    	createOutlineElements();
    	var pseudoElement = {target: element};
    	self.singleHighlightLoop = setInterval(function(){
    		draw(pseudoElement);
    	}, 50);
